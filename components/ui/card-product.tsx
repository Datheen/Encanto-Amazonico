...
export function CardProduct({id, name, price, image }: Props) {
  ...
  return (
    <div className="bg-white/80 h-max rounded-4xl flex flex-col items-center">
      ...
      <button onClick={() => router.push(`/produtos/${id}`)} className="w-max hover:cursor-pointer relative group overflow-hidden active:scale-95 transition-colors duration-700 bg-green-700 text-white/90 px-20 rounded-full h-13 text-xl my-5">
